...
<ul class="nav nav-stacked">
    ...
    <?php foreach ($category as $key => $cname): ?>
        ...
        <?php if (array_key_exists($key, $menus)): ?>
            <?php if ($key == $ac): ?>
                <?php echo CHtml::tag('ul', array('id'=>'nav_'.$key, 'class'=>'mycollapse nav nav-stacked collapse in')); ?>
            <?php else: ?>
                <?php echo CHtml::tag('ul', array('id'=>'nav_'.$key, 'class'=>'mycollapse nav nav-stacked collapse')); ?>
            <?php endif; ?>
