...
<!--<input type="file" name="file[]" id="fileIds" class="col-lg-8"/>
<button type="button" id="fileSubmit" class="upload_submit_btn btn btn-default">确认上传图片</button>
<div class="col-lg-8">
...
<input id="fileImage" type="file" size="30" name="file[]" multiple="" class="col-lg-8">
<button type="button" id="fileSubmit" class="upload_submit_btn btn btn-default">确认上传图片</button>
...
<script src="/statics/js/zxxFile.js"></script>
<script>
	var params = {
